...
create table plano_contas (
  ...
  grupo text,                            -- agrupamento consolidado (ex: RECEITAS ORDINÁRIAS), usado no Relatório de Transparência
  grupo_codigo text,
...
-- ------------------------------------------------------------
-- AGRUPAMENTO CONSOLIDADO (usado no Relatório de Transparência)
-- ------------------------------------------------------------
